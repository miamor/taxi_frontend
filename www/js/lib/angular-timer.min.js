...
(function() {
  ...
  var languages = {
    ar: {
      ...
      week: function(c) { return ((c === 1) ? "Ø£Ø³Ø¨ÙˆØ¹" : "Ø£Ø³Ø§Ø¨ÙŠØ¹"); },
      day: function(c) { return ((c === 1) ? "ÙŠÙˆÙ…" : "Ø£ÙŠØ§Ù…"); },
      hour: function(c) { return ((c === 1) ? "Ø³Ø§Ø¹Ø©" : "Ø³Ø§Ø¹Ø§Øª"); },
      minute: function(c) { return ((c === 1) ? "Ø¯Ù‚ÙŠÙ‚Ø©" : "Ø¯Ù‚Ø§Ø¦Ù‚"); },
      second: function(c) { return ((c === 1) ? "Ø«Ø§Ù†ÙŠØ©" : "Ø«ÙˆØ§Ù†ÙŠ"); },
      millisecond: function(c) { return ((c === 1) ? "Ø¬Ø²Ø¡ Ù…Ù† Ø§Ù„Ø«Ø§Ù†ÙŠØ©" : "Ø£Ø¬Ø²Ø§Ø¡ Ù…Ù† Ø§Ù„Ø«Ø§Ù†ÙŠØ©"); }
    },
    ca: {
    ...
    ru: {
      year: function(c) { return ["Ð»ÐµÑ‚", "Ð³Ð¾Ð´", "Ð³Ð¾Ð´Ð°"][getRussianForm(c)]; },
      month: function(c) { return ["Ð¼ÐµÑÑÑ†ÐµÐ²", "Ð¼ÐµÑÑÑ†", "Ð¼ÐµÑÑÑ†Ð°"][getRussianForm(c)]; },
      week: function(c) { return ["Ð½ÐµÐ´ÐµÐ»ÑŒ", "Ð½ÐµÐ´ÐµÐ»Ñ", "Ð½ÐµÐ´ÐµÐ»Ð¸"][getRussianForm(c)]; },
      day: function(c) { return ["Ð´Ð½ÐµÐ¹", "Ð´ÐµÐ½ÑŒ", "Ð´Ð½Ñ"][getRussianForm(c)]; },
      hour: function(c) { return ["Ñ‡Ð°ÑÐ¾Ð²", "Ñ‡Ð°Ñ", "Ñ‡Ð°ÑÐ°"][getRussianForm(c)]; },
      minute: function(c) { return ["Ð¼Ð¸Ð½ÑƒÑ‚", "Ð¼Ð¸Ð½ÑƒÑ‚Ð°", "Ð¼Ð¸Ð½ÑƒÑ‚Ñ‹"][getRussianForm(c)]; },
      second: function(c) { return ["ÑÐµÐºÑƒÐ½Ð´", "ÑÐµÐºÑƒÐ½Ð´Ð°", "ÑÐµÐºÑƒÐ½Ð´Ñ‹"][getRussianForm(c)]; },
      millisecond: function(c) { return ["Ð¼Ð¸Ð»Ð»Ð¸ÑÐµÐºÑƒÐ½Ð´", "Ð¼Ð¸Ð»Ð»Ð¸ÑÐµÐºÑƒÐ½Ð´Ð°", "Ð¼Ð¸Ð»Ð»Ð¸ÑÐµÐºÑƒÐ½Ð´Ñ‹"][getRussianForm(c)]; }
    },
    sv: {
      year: "Ã¥r",
      month: function(c) { return "mÃ¥nad" + ((c !== 1) ? "er" : ""); },
